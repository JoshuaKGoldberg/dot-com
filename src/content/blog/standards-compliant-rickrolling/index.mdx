...
image:
  ...
  src: "~/assets/blog/rick-astley.png"
---

import rickAstleyDancing from "~/assets/blog/rick-astley-dancing.webm";
...
I had used that as a form of aggressive user engagement encouragement on the [FullScreenMario](https://wikipedia.org/wiki/FullScreenMario) site to blast visitors with the old nostalgia-inducing Super Mario Bros.
theme.
