...
Many thanks to [Dan Vanderkam](https://www.danvk.org) for getting started on `no-unnecessary-type-parameters`: both the practical rule implementation and helping spread thee Golden Rule of Generics.
_Effective TypeScript_ is an excellent read, especially the second edition.

Additional thanks to [Daniel Afonso](https://www.danieljcafonso.com) for helpful proofreading on this blog post. 💖
