...
Their costs can be much higher than expected -- which is part of why sponsoring open source projects is so important.
...
That's just as annoying and mind-melting as it sounds.
...
There is a finite number of these tasks that I as an open source maintainer can take on before the "joy" of coding yields to the dullness of burnout.
...
The monetary compensation cost of this lint rule rule will easily exceed **well over two thousand dollars**.
