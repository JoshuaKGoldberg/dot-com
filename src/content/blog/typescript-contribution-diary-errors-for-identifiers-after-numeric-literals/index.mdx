...
import drakeSpecSyntaxErrata from "./drake-spec-synta-errata.webp";
import tsdevtest3inError from "./tsdevtest-3in-error.webp";
import tsdevtestResult3 from "./tsdevtest-result-3.webp";
import tsdevtestResult4 from "./tsdevtest-result-4.webp";
import tsdevtestParseElementThrice from "./tsdevtest-parseElement-thrice.png";
import tsdevtestTargetESNext from "./tsdevtest-target-esnext.webp";
import tsdevtestVariousErrors from "./tsdevtest-various-errors.webp";
...
<LabeledImage
	alt="Meme of drake gesturing away from a first panel and happily pointing towards a second. First: 'User reported bugs or feature suggestions'. Second: 'ECMASAcript spec syntax errata'."
