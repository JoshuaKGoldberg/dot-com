...
> 💡 Not familiar with typed linting?
...
TypeScript itself also runs at JIT speed, and therefore type information will be JIT speed as well.
...
Native speed linters are certainly excellent, but I don't think their performance is going to be as big of a differentiator as the initial hype cycle thinks.
...
ESLint itself has no concept of TypeScript or types in its core architecture or lint rules.
...
My personal vision for a linter is different from ESLint's, so I've naturally come to a different conclusion.
