...
- Native speed core (i.e. [Biome](https://biomejs.dev), [deno lint](https://docs.deno.com/runtime/reference/cli/lint), [Oxlint](https://oxc.rs/docs/guide/usage/linter)): often with first-party plugins for those needs
...
I'm not saying native speed linters such as Biome, deno lint, or Oxlint shouldn't exist or that you shouldn't use them.
