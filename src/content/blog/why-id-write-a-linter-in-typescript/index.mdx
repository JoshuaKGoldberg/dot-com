...
> 👉 I've written about why typed linting with Git commit hooks is fundamentally flawed: TODO.
...
[typescript-eslint-language-service](https://github.com/Quramy/typescript-eslint-language-service) and [TSSLint](https://github.com/johnsoncodehk/tsslint) are integrations I'd already like to explore with typescript-eslint now that our [project service is stable](https://typescript-eslint.io/blog/announcing-typescript-eslint-v8#project-service).
