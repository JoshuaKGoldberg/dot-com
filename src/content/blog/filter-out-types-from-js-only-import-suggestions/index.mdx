...
Thanks as always to [Mateusz Burzyński](https://github.com/Andarist) for helping review the PR. So much that it was more than reasonable for me to add Mateusz as a co-author 😄.
