...
- [Commenting on namespaces](https://github.com/microsoft/TypeScript/pull/53619#discussion_r1161166760) along with [@sandersn](https://github.com/sandersn): I was still interested in using `symbol.flags`, as that would help deal with unforseen edge cases in imports such as type-only namespaces.
...
@sandersn asked a about namespaces and suggested adding a type for `export type testNamespacedType` inside a namespace.
...
TypeScript 5.3 will include the language server improvements.
🥳
