...
TypeScript itself is also investing in better performance.
...
Our experience has been that the the majority of codebases benefit from the slower, more in-depth type checking with typed lint rules.
...
Both seem promising.
I think running ESLint as a language service plugin is more feasible in the short-term for the sake of compatibility with existing rules.
...
[ESLint's creator, Nicholas Zakas, has indicated interest in seeing similar improvements to ESLint](https://twitter.com/slicknet/status/1730634730406658453).
...
- Ezno: [Ben](https://github.com/kaleidawave) left a lovely pull request review around phrasing, levels of detail, and some discussions around backing up performance claims.
