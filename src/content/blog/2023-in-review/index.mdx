...
Let's look at the actual point of my career: pushing open source coding forward
...
| Objective                          | Status            |
| ---------------------------------- | ----------------- |
| Send two PRs to TypeScript a month | ❌ Not even close |
...
### Goal: Community Engagement & Conferences
