...
<PieChart
	...
	options={{
		plugins: {
			title: {
				text: "Monthly Income - All Sources",
			},
		},
	}}
/>
...
- ~$2,300 a month from typescript-eslint's revenue: mostly via [Open Collective](https://opencollective.com/typescript-eslint "typescript-eslint Open Collective"), with additional bits from [Tidelift](https://tidelift.com) and [Thanks.dev](http://thanks.dev)
	...
	options={{
		plugins: {
			title: {
				...
				padding: 20,
				fullSize: true,
				text: "Monthly Income - Open Source",
			},
		},
	}}
/>
...
<PieChart
	...
	options={{
		plugins: {
			title: {
				text: "Monthly Income - Side Projects",
			},
		},
	}}
/>
...
Enough of looking at which past goals I did or didn't do.
...
Half of my goals I succeeded in.
...
As they say: _"Ds get degrees, but Cs really please."_

The following sections go through each of the high-level goals I described in [My Plans for 2023](../my-plans-for-2023)
Note that they don't capture many of the smaller, non-tangible things I worked in in 2023.
I started and stopped rounds of mentorships, volunteered at bootcamps, and did all sorts of other smaller things.
I ascribe to the _"[Slack](https://www.google.com/books/edition/Slack/XPQJAQAAMAAJ?hl=en)"_ ideology of always leaving a hefty percentage of room to let yourself grow and explore.
...
But that took until December and I haven't yet had time to sett up tasks (let alone automations) for checking on repeat contributors, sending them money, or shouting them out on social media.
...
Yeah, I never really had time for this.
Maybe if there's a second edition of the book.
...
My streams are at the point where I consistently have around a dozen people join, and a small handful in the chat.
Which is perfect.
...
I don't work as effectively when I don't eat healthy, exercise, get good sleep, and manage my stress levels.
My insomnia in particular gets bad when I don't.
...
<LabeledVideo
	alt="Barney in The Simpsons shakily flying a helicopter. Spoken caption: Whoa. Hey, I think I'm gettin' it!"
	...
	src="/images/blog/whoa-hey-i-think-im-gettin-it.webm"
/>
