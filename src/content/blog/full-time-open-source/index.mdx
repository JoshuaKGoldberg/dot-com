...
import soLong from "./so-long.gif";
import goingOnAnAdventure from "./going-on-an-adventure.gif";
...
<LabeledMedia original="https://giphy.com/gifs/spongebob-squarepants-leave-smooth-48FhEMYGWji8">
	<img
		alt="Spongebob suavely backing out of a room with the caption 'So Long!'"
		src={soLong.src}
	/>
</LabeledMedia>
...
<LabeledMedia original="https://giphy.com/gifs/hobbit-xKeqcRfET8be">
	<img
		alt="Frodo happily running with the caption 'I'm going on an adventure!'"
		src={goingOnAnAdventure.src}
	/>
</LabeledMedia>
