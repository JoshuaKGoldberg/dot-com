...
image:
  ...
  src: ~/assets/centered-webpack-bundle-analyzer-1.png
pubDate: 2023-08-07 10:00 GMT
title: "Speeding Up Centered Part 2: Hidden Embedded Images"
---

import LabeledImage from "~/components/blog/mdx/LabeledImage.astro";
import lighthousePerformanceDiagnosticsPayloads from "~/assets/lighthouse-performance-diagnostics-payloads.png";
import lighthousePerformanceOverviewAfter from "~/assets/lighthouse-performance-overview-after.png";
import lighthousePerformanceOverviewBefore from "~/assets/lighthouse-performance-overview-before.png";
import lighthousePerformanceLcpOpportunities from "~/assets/lighthouse-performance-lcp-opportunities.png";
import webpackBundleAnalyzerClientBefore from "~/assets/webpack-bundle-analyzer-client-before.png";
import webpackBundleAnalyzerClientAfter from "~/assets/webpack-bundle-analyzer-client-after.png";
