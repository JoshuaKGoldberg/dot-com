...
image:
  ...
  src: centered-webpack-bundle-analyzer.png
pubDate: 2023-08-07
title: "Speeding Up Centered Part 2: Hidden Embedded Images"
---

import LabeledImage from "~/components/blog/mdx/LabeledImage.astro";
import lighthousePerformanceDiagnosticsPayloads from "./lighthouse-performance-diganostics-payloads.png";
...
<LabeledImage
	alt="LCP Opportunities and Diagnostics in the Lighthouse Performance report. Estimated Savings: 5.31s from Reduced Unused JavaScript; 2.56s from Preload Largest Contentful Paint Image. Diagnostics: Avoid enormous network payload s- total sive was 26,705 KiB."
...
<LabeledImage
	alt="Webpack Bundle Analyzer gzipped output FoamTree visualization. Total chunk size is 7.28 MB, and the biggest chunk is pages/_app at 4.75 MB."
...
<LabeledImage
	alt="Lighthouse performance report of 36 (in the red). 0.6 First Contentful Paint (green), 17.6 Largest Contentful Paint (red), 950ms Total Blocking Time (red), 0.044 Cumulative Layout Shift (green), 6.7s Speed Index (red)."
...
The next two posts in this series will show off how we removed plenty more unnecessary files to get that performance score to a much better place.
