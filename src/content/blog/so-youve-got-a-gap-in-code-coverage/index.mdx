...
- [This is a difficult-to-represent edge case in types and a type assertion is warranted](#this-is-a-difficult-to-represent-edge-case-in-types-and-a-type-assertion-is-warranted)
