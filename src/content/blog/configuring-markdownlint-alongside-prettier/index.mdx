...
image:
  ...
  src: "~/assets/blog/superintendent.png"
series: Linters
title: "Configuring Markdownlint Alongside Prettier"
---

import LabeledImage from "~/components/blog/mdx/LabeledImage.astro";
import superintendentWide from "~/assets/blog/superintendent-wide.png";
...
<LabeledImage
	...
	src={superintendentWide}
/>

> ⚠️ Warning: this blog post is now out of date.
> As of 2026, [`@eslint/markdown`](https://github.com/eslint/markdown) is now my preferred lint choice for Markdown files.
