...
> Updated June 11th, 2025: I added this section after the initial post.
...
Once a usable cross-file cache in place, re-running linting should be much faster -- we can unlock a fast `--watch` mode to help with it too.
