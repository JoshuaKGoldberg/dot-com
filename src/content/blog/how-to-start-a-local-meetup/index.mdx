...
> TODO: Reframe as how _we_ started one, and note more about variance
> Example: https://fosstodon.org/@danrot@mastodon.social/114714446001481640
...
If an event lasts multiple hours, people will generally expect food.
...
For Boston TS Club, we have a private vegan caterer -[@plantiful.cooking](https://www.instagram.com/plantiful.cooking)- who does a wonderful job.
Caterers like Savannah are generally more expensive than chain restaurants, but in my experience are much better.
Savannah makes great food, provides a fun set of different choices each month, and is much more pleasant to work with.
...
But, that brings up a challenge: how do you accept in-person payment?
...
Finding a range of speakers that represents many swathes of the community is even harder.
Meetups in areas with a less diverse community have that much harder of a challenge.

TODO: consider replacing this with more action-oriented advice?
