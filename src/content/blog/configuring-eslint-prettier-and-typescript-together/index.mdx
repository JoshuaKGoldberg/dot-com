...
image:
  ...
  src: "~/assets/blog/react-miami-me-speaking.jpg"
pubDate: 2023-05-01
series: Linters
...
import april from "~/assets/blog/april.webm";
import needsMoreLintRules from "~/assets/blog/needs-more-lint-rules.webm";
import otterCleaning from "~/assets/blog/otter-cleaning.webm";
import EmbeddedIframe from "~/components/blog/mdx/EmbeddedIframe.astro";
...
<EmbeddedIframe
	...
	title="React Miami talk: Configuring ESLint, Prettier, and TypeScript Together"
>
	<a
		href="https://www.youtube.com/live/mPPZ-NUnR-4?feature=share&t=25743"
		slot="primary"
		target="_blank"
	>
	...
	<Fragment slot="secondary">
		Photo credit
		<a href="https://twitter.com/Beccalytics" target="_blank">Rebecca Bakels</a>.
		<a href="https://1drv.ms/p/s!AvUc1cvPrJnWvt0cjx-_PLIwDIzclw" target="_blank">See the PowerPoint slides here</a>.
	</Fragment>
</EmbeddedIframe>
...
- [create-typescript-app](https://github.com/JoshuaKGoldberg/create-typescript-app): Template repo I maintain that sets up these three tools (and more!) in a general Node package
...
<LabeledVideo
	...
	description="Formatters clean your code. That's all they do."
	original="https://giphy.com/gifs/montereybayaquarium-face-otter-sea-1xlGfZ07Dq62jqKT9t"
	src={otterCleaning}
/>
...
> Edit (January 2024): `reportUnusedDisableDirectives: true,` is now a configuration option you can set in your ESLint config file!
> [`create-typescript-app`](https://github.com/JoshuaKGoldberg/create-typescript-app) has been updated.
...
[`--max-warnings`](https://www.eslint.com/docs/2.0.0/user-guide/command-line-interface#--max-warnings) allows you to specify a maximum number of warnings that are permitted.
...
<LabeledVideo
	...
	description="me and all other linter maintainers irl having to deal with formatting rules"
	original="https://giphy.com/gifs/parksandrec-episode-5-parks-and-recreation-rec-76Nahzjx4Y6WXP2APE"
	src={april}
/>
...
People like to describe TypeScript as a _"superset of JavaScript"_ (a.k.a.
_"JavaScript with types"_).
...
This includes any questions you might have about plugins like eslint-config-prettier, eslint-plugin-prettier, tslint, tslint-config-prettier, and tslint-plugin-prettier.
