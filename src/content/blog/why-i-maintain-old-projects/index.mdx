---
description: "I've taken on maintenance of older projects such as dedent, Mocha, and Yeoman. It might seem odd at first: if I want to push web development forward, why do I spend time on its past?"
image:
  alt: TODO
...
title: "Why I Maintain Old Projects"
---
...
For each of those projects, I posted an issue explaining that the maintenance goal was to keep the project stable.
...
I find these projects fascinating to dig into.
...
[I earned $60k in 2024, my third year of full time open source](/blog/2024-finances-in-review).
Projects like Mocha and Yeoman that distribute funding to maintainers are a valuable source of income for me.

From another perspective: some of open source labor is paid.
Some open source labor is unpaid.
I have the ability to execute labor of the paid variety, and am choosing to exercise it.

## Want to Help Out?

Open source is fun.
You get to work with people all over the world with drastically difference areas and levels of experience.
Contributing is a great way to learn, contribute to your ecosystem, and bolster your software street cred.

If you're interested in working on any open source projects -especially ones I help maintain- then please try it out!
GitHub's [New to open source? Here’s everything you need to get started](https://github.blog/open-source/new-to-open-source-heres-everything-you-need-to-get-started) is a great article on go from nothing to a first contribution.

All of the projects mentioned in this post have open issues ready to be resolved at time of writing:

- [dedent issues](https://github.com/dmnd/dedent/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22status%3A%20accepting%20prs%22%20no%3Aassignee)
- [eslint-plugin-expect-type issues](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22status%3A%20accepting%20prs%22%20no%3Aassignee)
- [Mocha issues](https://github.com/issues?q=is%3Aopen+is%3Aissue+org%3Amochajs+label%3A%22status%3A+accepting+prs%22+archived%3Afalse+no%3Aassignee)
- [package-json-validator issues](https://github.com/JoshuaKGoldberg/package-json-validator/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22status%3A%20accepting%20prs%22%20no%3Aassignee)
- [Yeoman issues](https://github.com/issues?q=is%3Aopen+is%3Aissue+org%3Ayeoman+label%3A%22actionable%22+archived%3Afalse+no%3Aassignee+)

If you want any help sending your first issue or pull request, you can always DM or email me.
Let's push forward the web development ecosystem together.
💖
