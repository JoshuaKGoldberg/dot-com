...
image:
  ...
  src: "~/assets/blog/thinker-gates-of-hell.jpg"
pubDate: 2022-01-18
title: "Nature, Individuality, and Developer Empowerment"
---

import LabeledImage from "~/components/blog/mdx/LabeledImage.astro";
import thinkerGatesOfHellWide from "~/assets/blog/thinker-gates-of-hell-wide.jpg";
...
> Seen in this perspective, the forces that govern the world are ...
> not addressed to us.
...
_(I'm slightly manipulating the chapter's intent and ignoring many interpretations of the monotheistic God to make a more narrow point.
For a real religious discussion, go read the book!)_
