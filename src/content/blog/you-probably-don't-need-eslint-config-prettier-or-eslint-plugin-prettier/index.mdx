...
We should also note that although I personally disagree with `eslint-config-prettier` and `eslint-plugin-prettier`, they are legitimately useful tools for many.
I like to think that they've helped many folks onboard to formatting and/or linting their code.
Many thanks to their maintainers over the years!
❤️
