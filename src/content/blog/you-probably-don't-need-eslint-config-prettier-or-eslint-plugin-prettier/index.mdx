...
Back in the day, popular shareble configs such as [`eslint-config-airbnb`](https://www.npmjs.com/package/eslint-config-airbnb) were often used to enable many rules at once.
