...
Thanks also to [Simon Lydell](https://github.com/lydell), the original creator and a long-time maintainer of `eslint-config-prettier`, for reviewing the post and suggesting the `npx eslint-config-prettier` approach.
