...
But, I think ESLint's flat config has learned the hard way what nuances trip people up this far outside the "walled garden" of pure JSON:
...
// VERY ROUGH SKETCH, I THINK I WILL REDO THIS COMPLETELY :)
// (looking back a few months later I don't find it as readable as I used to...)
