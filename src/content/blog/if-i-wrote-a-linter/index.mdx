...
But, typed linting is not an easy feature for many users.
The divide between untyped core rules and _only some_ typed rules is painful for the whole ecosystem:
