...
<LabeledMedia description="Sisyphus working through a queue of issues on a popular GitHub repository">
	<img alt="Sisyphus rolling a boulder up a hill" src={sisyphus.src} />
</LabeledMedia>
