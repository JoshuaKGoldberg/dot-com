...
Most meetups happening near a conference have some kind of connection, so you've got a great chance of meeting organizers and speakers there too.
...
Seeing people constantly say things like _"it's ok to be awkward, we all are!"_ and _"keep trying, we all get better over time"_ helped too.
...
This is useful for me to retain information: both in that note-taking actually does help with memory, and in that I like having the notes to refer to later.
...
So you attended a conference, met a bunch of people, exchanged LinkedIns...
now what?
