...
Problem: how do we restrict the input types...
of our `type`s?
...
An “eight bit integer” is an integer value represented using...
eight bits!
...
A "mapped type" is one that transforms the properties of some input type.
It...
maps them!
