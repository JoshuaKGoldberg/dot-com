...
It was exported from the `index.ts` of a shared components package.
Re-exporting many components from one file is a pattern called _"barrel export"_[^1].
It's commonly used to help establish a single, easy-to-find place for many useful values and/or types.
...
- Fix your build system to enable tree shaking of barrel exports _(generally the right way)_
...
Look forward to them in the next few weeks!
