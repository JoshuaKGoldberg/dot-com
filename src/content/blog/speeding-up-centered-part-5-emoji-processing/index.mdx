...
import lighthousePerformanceOverviewOriginal from "~/assets/lighthouse-performance-overview-original.png";
import lighthousePerformanceProfileAfterLongTask from "~/assets/lighthouse-performance-profile-after-long-task.png";
import lighthousePerformanceProfileBeforeLongTask from "~/assets/lighthouse-performance-profile-before-long-task.png";
import sourceBeforeLineAnnotations from "~/assets/source-before-line-annotations.png";
