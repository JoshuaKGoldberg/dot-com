...
import vscodeLintScreenshot from "~/assets/blog/vscode-lint-screenshot.png";
import vscodeTerminalScreenshot from "~/assets/blog/vscode-terminal-screenshot.png";
...
I don't have mockups yet, but it would at least:

- Default to a "high-level" overview that focuses on summaries, leaving more space for...
