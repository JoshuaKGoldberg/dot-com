...
Rule names have to make several naming options to choose between:
...
- Prefixes:
  ...
  - No prefix: `array-callback-return`
- Singularity:
...
- Abbreviation:
  - Having to memorize many abbreviations is an annoyance at best and confusing at worst
  - Some words abbreviate to coincidentally different meanings, such as "constant" and "const"
- Prefixes:
  - Alphabetical sorting of rules places them similarly prefixed rules together, weirdly
  - Many rules have had to drop their prefix after receiving an option to invert their behavior [^tseslint-discussion-no-prefixing-rule-names]
- Singularity: the least troublesome, but the inconsistency I still find painful
...
For example, I would rework the following rule names:
...
<table>
	...
	<tbody>
		<tr>
			<td>
				<a
					href="https://eslint.org/docs/latest/rules/array-callback-return"
					target="_blank"
				>
			...
			<td>
				<code>arrayCallbackReturns</code>
			</td>
		</tr>
		<tr>
			<td>
				<a
					href="https://typescript-eslint.io/rules/ban-ts-comment"
					target="_blank"
				>
					<code>ban-ts-comment</code>
				</a>
			</td>
			<td>
				<code>typescriptCommentDirectives</code>
			</td>
		</tr>
		<tr>
			<td>
				<a
					href="https://eslint.org/docs/latest/rules/no-await-in-loop"
					target="_blank"
				>
			...
			<td>
				<code>loopAwaits</code>
			</td>
		</tr>
		<tr>
			<td>
				<a
					href="https://eslint.org/docs/latest/rules/no-cond-assign"
					target="_blank"
				>
			...
			<td>
				<code>conditionalAssignments</code>
			</td>
		</tr>
		<tr>
			<td>
				<a
					href="https://eslint.org/docs/latest/rules/no-const-assign"
					target="_blank"
				>
					<code>no-const-assign</code>
				</a>
			</td>
			<td>
				<code>constAssignments</code>
			</td>
		</tr>
		<tr>
			<td>
				<a
					href="https://eslint.org/docs/latest/rules/no-constant-binary-expression"
					target="_blank"
				>
					<code>no-constant-binary-expression</code>
				</a>
			</td>
			<td>
				<code>constantBinaryExpressions</code>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<a
					href="https://typescript-eslint.io/rules/restrict-plus-operands"
					target="_blank"
				>
					<code>restrict-plus-operands</code>
				</a>
			</td>
			<td>
				<code>plusOperands</code>
			</td>
		</tr>
	</tbody>
</table>
...
- Options: an array of literals? an object with keys for option names?
  ...
  - Option names: `allow*`? `check*`? `enforce*`? `require*`? Just the `*` (functionality)?
  - Option value defaults: off-by-default? on-by-default?
...
- Options: always an object with keys for option names
  ...
  - Option value defaults: the default value should always be empty/falsy, and anything else is confusing
...
### Standardized Type Or Value Specifiers
