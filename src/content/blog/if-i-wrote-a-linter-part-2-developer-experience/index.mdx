...
And maybe the settings for _Details_ and _Focused view_ would remain persistent per-package or per-system?
...
will need a rule auto-fixer to make this ergonomic
note to put that in ecosystem as first-party
