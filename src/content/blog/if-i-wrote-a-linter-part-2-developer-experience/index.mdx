...
I also imagine there could be some interactive controls to let the user collapse/expand the report and navigate between files or reports within a file.
