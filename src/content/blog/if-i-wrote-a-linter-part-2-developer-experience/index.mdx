...
This blog post describes the main changes I would make to the current status quo of the linting developer experience if I wrote a linter.
...
co-authored-by: kirk (todo add thanks)
