...
import aladdinAndJasmine from "./aladdin-and-jasmine.gif";
import hamstersSwarming from "./hamsters-swarming.gif";
...
>
	<img alt="The Death of Socrates (painting)" src={deathOfSocrates.src} />
</LabeledMedia>
...
>
	<img alt="Hamsters swarming" src={hamstersSwarming.src} />
</LabeledMedia>
