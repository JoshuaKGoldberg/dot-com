...
> Edit (January 2024): Since writing this blog post, [ESLint core deprecated formatting rules](https://eslint.org/blog/2023/10/deprecating-formatting-rules) and [ESLint Stylistic](https://eslint.style) was announced and released.
> Hooray! 🙌
...
I now use it in my [create-typescript-app](https://github.com/JoshuaKGoldberg/create-typescript-app)'s [`.prettierrc`](https://github.com/JoshuaKGoldberg/create-typescript-app/blob/ff623074af4811c69ceeb8ed277ef7f0fdb14ea2/.prettierrc).
...
It's the first time I've written a Prettier plugin and I'd love to be told how to improve it.
❤️
...
It's enabled in my [create-typescript-app](https://github.com/JoshuaKGoldberg/create-typescript-app)'s [`.eslintrc.cjs`](https://github.com/JoshuaKGoldberg/create-typescript-app/blob/a6feabdf3cb7aa525167168652a17bd2c3de2330/.eslintrc.cjs#L20).
