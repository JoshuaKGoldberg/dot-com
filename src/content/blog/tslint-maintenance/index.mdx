...
We can talk all we want about work/life balance and how volunteer work should be a pleasant experience and how open source should be a golden utopia of working towards common goals...
...
[**Andrii Dieiev**](https://github.com/IllusionMH) came out of nowhere later on and helped support and eventually maintain the library as well.
Beyond general maintainership, Andrii did a particularly great job on improvements to its build and release processes.
