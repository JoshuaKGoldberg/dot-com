...
Many of the core competencies for working with a community ecosystem are different from those for coding.
I think the ideas in this blog post are a nice blend of the areas.
