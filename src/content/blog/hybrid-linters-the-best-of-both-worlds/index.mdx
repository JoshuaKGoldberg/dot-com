...
Depending on what parts of disk scanning, file I/O, and other tasks that work better in native code, the performance penalty of a JIT speed core might be too high.
