...
But, I don't think it solves the approachability issue.
...
Both options incur maintenance cost: separately documenting JavaScript rules and/or having to maintain two documented paths for rules.
I think it's better to have a single primary paradigm for lint rules.
For the sake of approachability, I think that paradigm should be JavaScript/TypeScript.
