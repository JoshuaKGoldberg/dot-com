...
4. Once lint rules are JavaScript-speed, you might as well write coordinating logic in TypeScript as well.
...
Depending on what parts of disk scanning, file I/O, and other tasks that work better in native code, the performance penalty of a JavaScript-speed core might be too high.
