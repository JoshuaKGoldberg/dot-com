...
5. Increase the power and simplicity of other developer tooling provided by [create-typescript-app](#create-typescript-app)
...
This is not ideal.
I'd prefer to not have to do consulting at all.
