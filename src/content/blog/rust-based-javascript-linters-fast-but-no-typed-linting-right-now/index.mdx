...
image:
  alt: A black cat alying on a bed with its eyes half-closed. It looks sassy.
  src: jerry-sass.jpg
pubDate: 2024-01-10
tags: [
	"biome",
...
<LabeledImage
	alt="A black cat alying on a bed with its eyes half-closed. It looks sassy."
	description="Jerry the cat with the same facial expression I get when a team doesn't used typed linting."
	src={jerrySass}
/>
