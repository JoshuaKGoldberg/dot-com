...
<LabeledVideo
	...
	description="Seen: a maintainers trying to find phrasing that discourages these reports while still encouraging security as a practice."
...
Security reporting platforms such as [HackerOne](https://docs.hackerone.com/en/articles/8475116-quality-reports) categorically do not allow reports that don't include at least a set of steps to achieve an exploit reproduction.
