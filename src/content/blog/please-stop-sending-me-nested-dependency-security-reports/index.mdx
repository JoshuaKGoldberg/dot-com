...
As an open source maintainer, I regularly receive "critical security vulnerabilities" DMs, emails, and GitHib issues from individual developers or IT teams about packages that are dependencies of dependencies of my packages.
...
<LabeledVideo
	...
	description="Captured: an open source maintainer trying to find phrasing to discourage these security repo while still encouraging security as a practice"
...
Vulnerabilities in my packages -even direct dependencies- might be something that impacts users.
