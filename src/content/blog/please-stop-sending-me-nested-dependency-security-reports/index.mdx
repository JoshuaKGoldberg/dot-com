...
<LabeledVideo
	...
	description="Captured: an open source maintainer trying to find phrasing that discourage these reports while still encouraging security as a practice..."
...
> 💡 Other tools such as [Socket](https://socket.dev) and [Snyk](https://snyk.io) provide more options around prioritizing issues and/or ignoring vulnerabilities that don't impact the APIs you use.
...
> None of their development work is free - even if you don't personally pay for it.
