...
pubDate: 2024-04-22
title: "DefinitelyFormatted"
---

import battleOfKöniggrätz from "~/assets/blog/battle-of-königgrätz.webp";
...
It contains over 9,000 folders storing community-authored TypeScript type definitions for JavaScript projects that don't ship their own types.
...
As a [former maintainer of TSLint](./tslint-maintence), I was motivated to help move DefinitelyTyped onto ESLint and off of the deprecated TSLint.
...
Many repositories integrate formatters in up to three common ways:
...
David Sherret and Jake Bailey did end up sending several issues and pull requests around dprint and swc to support the work.
...
Many of the issues we filed as a part of this work were resolved within days -or even hours- by David or kdy.
