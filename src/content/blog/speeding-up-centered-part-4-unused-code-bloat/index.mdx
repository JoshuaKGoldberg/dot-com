...
It found quite a few unused areas of code!

Quoting and summarizing its output:

- `Unused dependencies (18)`: `package.json` dependencies not transitively imported or referenced by any of the pages
- `Unused files (50)`: source files also not transitively imported or referenced by any of the pages

I uninstalled the unused dependencies and deleted the unused files.
...
Sometimes they do virtually nothing instead.
