...
image:
  ...
  src: "~/assets/blog/knip-json.png"
pubDate: 2023-08-21 10:01 GMT
title: "Speeding Up Centered Part 4: Unused Code Bloat"
---

import centeredKnip from "~/assets/blog/centered-knip.webm";
...
You can see it in action in my [create-typescript-app](https://github.com/JoshuaKGoldberg/create-typescript-app).
