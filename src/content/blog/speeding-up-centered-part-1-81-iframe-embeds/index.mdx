...
image:
  ...
  src: "~/assets/blog/quotes-dom-iframes.png"
pubDate: 2023-07-19
title: "Speeding Up Centered Part 1: 81 <iframe> Embeds"
---

import centeredLoadingQuotesPageAfter from "~/assets/blog/centered-loading-quotes-page-after.webm";
import centeredLoadingQuotesPageBefore from "~/assets/blog/centered-loading-quotes-page-before.webm";
import mrBeanWaiting from "~/assets/blog/mr-bean-waiting.webm";
import LabeledImage from "~/components/blog/mdx/LabeledImage.astro";
import LabeledVideo from "~/components/blog/mdx/LabeledVideo.astro";
import centeredAppScreenshot from "~/assets/blog/centered-app-screenshot.png";
import quotesDomIframes from "~/assets/blog/quotes-dom-iframes.png";
...
I tried visiting centered.app/quotes, and ...
wow!
They were right.
...
<LabeledVideo
	...
	src={centeredLoadingQuotesPageBefore}
/>

On my Mac Mini with an M1 Max chip, the page took _ten seconds_ to populate page
content.
Yikes! Users tend to abandon pages after ~2-3 seconds at most, let alone
double digits.
...
<LabeledVideo
	...
	src={centeredLoadingQuotesPageAfter}
/>
