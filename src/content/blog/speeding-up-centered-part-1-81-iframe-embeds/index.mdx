...
image:
  ...
  src: ~/assets/quotes-dom-iframes.png
pubDate: 2023-07-19
...
import centeredAppScreenshot from "~/assets/centered-app-screenshot.png";
import quotesDomIframes from "~/assets/quotes-dom-iframes.png";
