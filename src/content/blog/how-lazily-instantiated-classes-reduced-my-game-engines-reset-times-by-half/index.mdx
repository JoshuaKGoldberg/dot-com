...
image:
  ...
  src: "~/assets/fsp-game-loading-profile.png"
pubDate: 2017-10-09
title: "How lazily instantiated classes reduced my game engines' reset times by half"
---

import LabeledImage from "~/components/blog/mdx/LabeledImage.astro";
import objectmakrAfter from "~/assets/objectmakr-after.webp";
import objectmakrBefore from "~/assets/objectmakr-before.webp";
